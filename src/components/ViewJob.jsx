    ...
    return (
        <div className='max-w-[1240px] mx-auto w-[100vw] h-[100vh] flex items-center justify-center relative ' >
            ...
            <div className='bg-[#fff] flex flex-col items-center justify-center px-20 py-10  shadow-lg border-gray-100 rounded-md border-2 border-solid ' >
                ...
                <h3 className='text-xl font-bold ' >View Job</h3>

                <div className='my-3 flex flex-col items-start w-[100%]' >
                    <label htmlFor="title">Job Title</label>
                    <input type="text" className='w-[100%] py-2 px-4  border-gray-100 rounded-md border-2 border-solid outline-none' />
                </div>
                ...
                <div className='my-3 flex flex-col items-start w-[100%]' >
                    ...
                    <textarea name="" id="" cols="20" rows="3"
                        className='w-[100%] py-2 px-4  border-gray-100 rounded-md border-2 border-solid outline-none'
                    ></textarea>
                </div>
                ...
                <div className='my-3 flex flex-row justify-between w-[100%]' >
                    ...
                    <div className='flex flex-col items-start w-[48%]' >
                        ...
                        <input type="datetime-local" className='w-[100%] py-2 px-4  border-gray-100 rounded-md border-2 border-solid outline-none' />
                    </div>
                </div>
